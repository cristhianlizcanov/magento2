...
namespace Prueba\BackendSlider\Model;
...
class SlideRepository implements \Prueba\BackendSlider\Api\SlideRepositoryInterface
{
    /**
    * @var \Prueba\BackendSlider\Model\ResourceModel\Slide
    */
    protected $resource;

    /**
    * @var \Prueba\BackendSlider\Model\SlideFactory
    */
    protected $slideFactory;

    /**
    * @var \Prueba\BackendSlider\Model\ResourceModel\Slide\CollectionFactory
    */
    ...
    */
    ...
    /**
    * @var \Prueba\BackendSlider\Api\Data\SlideInterfaceFactory
    */
    ...
    * @param \Prueba\BackendSlider\Api\Data\SlideInterfaceFactory $dataSlideFactory
    */
    public function __construct(
        \Prueba\BackendSlider\Model\ResourceModel\Slide $resource,
        \Prueba\BackendSlider\Model\SlideFactory $slideFactory,
        \Prueba\BackendSlider\Model\ResourceModel\Slide\CollectionFactory $slideCollectionFactory,
        \Magento\Framework\Api\SearchResultsInterface $searchResultsFactory,
        \Magento\Framework\Api\DataObjectHelper $dataObjectHelper,
        \Magento\Framework\Reflection\DataObjectProcessor $dataObjectProcessor,
        \Prueba\BackendSlider\Api\Data\SlideInterfaceFactory $dataSlideFactory
    )
    {
 ...
 /**
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
    {
        ...
        foreach ($collection as $slideModel) {
            ...
            $this->dataObjectHelper->populateWithArray(
                $slideData,
                $slideModel->getData(),
                '\Prueba\BackendSlider\Api\Data\SlideInterface'
            );

            $slides[] = $this->dataObjectProcessor->buildOutputDataArray($slideData,'\Prueba\BackendSlider\Api\Data\SlideInterface');
        }
    ...
    */
    public function delete(\Prueba\BackendSlider\Api\Data\SlideInterface $slide)
    {
        try {
