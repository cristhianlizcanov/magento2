...
namespace Prueba\PowerBi\Block;

use Magento\Framework\View\Element\Template;
use Prueba\PowerBi\Model\ResourceModel\Demo\Collection as DemoCollection;
...
class DemoList extends Template
{
    ...
    public function __construct(
            ...
            \Prueba\PowerBi\Model\ResourceModel\Demo\CollectionFactory $collectionFactory,
            array $data = [])
    {
